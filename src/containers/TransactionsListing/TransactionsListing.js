...
import classes from "./TransactionsListing.css";
    ...
    return (
      <div>
        ...
        <div className={classes.pageHeader}>
          ...
          <div><input className={classes.searchInput} value={filter} placeholder="Search Transaction..." onChange={this.filterHandler} /></div>
        ...
        <section className={classes.listOfAdvs}>
          <BootstrapTable responsive="sm" size="sm" variant="dark" striped hover condensed keyField='title' data={advList} columns={columns} />
        </section>
      </div>
    );
  }
